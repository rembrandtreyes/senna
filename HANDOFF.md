...
- `templates/planning/`: PRD, tech spec, and feedback-ledger templates, each with a critic
  checklist. Built from Lyft's and Stack Overflow's spec guides plus PRD best practices.
